            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <tr>
                            <th class="text-right col-3">Jumlah Terjual:</th>
                            <td class="col-9">{{ $penjualan->jumlah }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Harga Jual:</th>
                            <td class="col-9">Rp {{ number_format($penjualan->harga_jual, 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Nama Pembeli:</th>
                            <td class="col-9">{{ $penjualan->nama_pembeli }}</td>
                        </tr>
                    </table>
                </div>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.status) {
                                ...
                                dataPenjualan.ajax.reload(); // Ganti sesuai nama variabel DataTable kamu
                            } else {
                                $('.error-text').text('');
