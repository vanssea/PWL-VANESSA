...
<body>
    ...
    @foreach ($penjualan as $p)
        <table class="border-all font-11 mb-2">
            <tr>
                <th width="15%">Kode</th>
            ...
            <tr>
                ...
                <td colspan="3">
                    Rp {{
                        number_format(
                            $p->penjualanDetail->sum(function($detail) {
        ...
        @if ($p->penjualanDetail->count())
            <table class="border-all font-11 mb-2">
                ...
                <tbody>
                    @foreach ($p->penjualanDetail as $i => $detail)
                        <tr>
